<!-- login page for updating the student data in all user dashboard -->
...
<?php
   ...
   ?>
    ...
    <div class="content">
        <center>
        <h1 class="title">Student Profile Login</h1><br>
        <h3 style="color:red">
                    <?php
        ...
        <div class="form_deg">
            <form action="student_check.php" method="POST" class="login_form">
