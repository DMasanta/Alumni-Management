<!-- Add Alumni Deatails in the Admin Dashboard -->
...
if(!$data){
    ...
    $check="SELECT * FROM alumni WHERE  registration = '$user_reg'";
...
$sql="INSERT INTO `alumni` (`fname`, `mname`, `lname`, `registration`, `batch`, `a_session`, `gender`, `email`, `phone`, `company`, `a_address`, `a_password`) 
VALUES ('$fname', '$mname', '$lname', '$user_reg', '$user_batch', '$user_session', '$user_gender', '$user_email', '$user_phone', '$user_company', '$user_address', '$user_password')";
    ...
    <div class="content">
        ...
        <div class="div_deg">
            ...
            <tr>
                ...
                <td width="450" style="border:hidden; padding-left: 5px;padding-bottom:5px"><input size="45" type="text" value="" name="fname" placeholder="Enter Alumni First name"/></td>
            </tr>
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Mid Name</th>
                <td width="450" style="border:hidden; padding-left: 5px;padding-bottom:5px"><input size="45" type="text" value="" name="mname" placeholder="Enter Alumni Mid name"/></td>
            </tr>
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Last Name</th>
                <td width="450" style="border:hidden; padding-left: 5px;padding-bottom:5px"><input size="45" type="text" value="" name="lname" placeholder="Enter Alumni Last name"/></td>
            </tr>
            
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Registration Number </th>
                <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px"><input size="45" type="text" value="" name="registration"placeholder="Enter Alumni Registration number"/></td>
            </tr>
            ...
            <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px"><input size="45" type="text" value="" name="session" placeholder="Enter Session"/>
            ...
            <tr>
                ...
                <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px"><input size="45" type="email" value="" name="email"placeholder="Enter Alumni email"/></td>
            </tr>
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Phone</th>
                <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px"><input size="45" type="phone" value="" name="phone"placeholder="Enter Alumni phone"/></td>
            </tr>
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Company</th>
                <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px"><input size="45" type="text" value="" name="company"placeholder="Enter Alumni current company name"/></td>
            </tr>
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Address </th>
                <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px">
                <!-- <input size="100" type="text" value="" name="address"/> -->
                <textarea name="address" type="text" placeholder="Enter Alumni Address" cols="30" rows="5"></textarea>
                </td>
            </tr>
            <tr>
                <th align="left" width="450" style="border:hidden;font-size:18px">Password </th>
                <td width="450" style="border:hidden; padding-left: 5px; padding-bottom:5px"><input size="45" type="password" value="" name="password"placeholder="Enter Alumni password"/></td>
            </tr>

            <td colspan=2 align="center" style="border:hidden"><input type="submit" class="btn btn-primary" name="add_alumni" value="Add Alumni"></td>
            </tr>
            </table>
            </form>
